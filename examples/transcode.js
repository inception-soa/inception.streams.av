...
node.fs.createReadStream(process.argv[2])
  .pipe(new AV.Transcoder({
    outputFormatName: AV.Muxers.s16le,
    outputAudioCodec: AV.Encoders.pcm_s16le,
    outputAudioSampleRate: 16000,
    outputAudioChannelLayout: AV.ChannelLayouts.MONO,
    outputVideoIgnore: true
  }))
  .on('progress', () => {
